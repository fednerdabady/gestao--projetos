                ...
                <!--<h1 class="text-white"style="font-family: Montserrat ;font: 25px Verdana, Geneva, sans-serif; margin-left: 600px "> Lista Cargos</h1>--> 
				 <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        <h1 style="font-family: Montserrat ;font: 25px Verdana, Geneva, sans-serif; margin-left: 400px">Lista de Movimentacao</h1> 
                    </ul>
                </div>
            </nav>
            <!-- <nav class="navbar top-navbar navbar-expand-md navbar-light">
        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    ...
                    <button type="button" class="btn btn-sm"><a style="font-family: Montserrat ;font: 15px Verdana, Geneva, sans-serif" href="novomovimentacao.php">Novo</a></button>
                        ...
                        <div class="card" style="background-color:lavender;">
                           ...
                           <table class="table table-hover"  style="font-family: Montserrat;color:blue; font: 13pt Verdana, Geneva, sans-serif;">
                            <thead >
                                   <tr>
                                       ...
                                       <th style="font-family: Montserrat; color:#002752;font: 13pt Verdana, Geneva, sans-serif;">Data_Movimentacao</th>
                                       <th style="font-family: Montserrat; color:#002752;font: 13pt Verdana, Geneva, sans-serif;">Natureza_Movimentacao</th>
                                       <th style="font-family: Montserrat; color:#002752;font: 13pt Verdana, Geneva, sans-serif;">Local_Estoque</th>
                                       <th style="font-family: Montserrat; color:#002752;font: 13pt Verdana, Geneva, sans-serif;">Numero_documento</th>
                                       <th style="font-family: Montserrat; color:#002752;font: 13pt Verdana, Geneva, sans-serif;">Tipo_documento</th>
                         ...
                         <?php
                            require_once 'conexao.php';			
                                    ...
                                    $result = "select * from movimentacaoestoque";
                              ...
                              while ($row = mysqli_fetch_array($resultado)) {
								   ?>  
                                    <tr>
                                                 ...
                                                 <td><?php echo utf8_encode($row['dataMov']); ?> </td>
                                                 <td><?php echo utf8_encode($row['naturezaMov']); ?> </td>
                                                 <td><?php echo utf8_encode($row['locEstoCodigo']); ?> </td>
                                                 <td><?php echo utf8_encode($row['NumDoc']); ?> </td>
                                                 <td><?php echo utf8_encode($row['tipoDoc']); ?> </td>
