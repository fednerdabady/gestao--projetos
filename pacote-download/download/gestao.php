...
<body class="fix-header fix-sidebar card-no-border logo-center">
    ...
    <div id="main-wrapper">
        ...
        <header class="topbar" style="height:60px">
					...
					<h1 class="text-white"style="font-family: Montserrat ;font: 25px Verdana, Geneva, sans-serif; margin-left: 600px "> Gestão</h1> 
                </nav>
            <!--<nav class="navbar top-navbar navbar-expand-md navbar-light">
               <a class="navbar-brand" href="#" style="margin-left:-41px;padding-top:0px;padding-bottom:12px"><img class="img-thumbnail" alt="logo" src="./imagens/logopassaura.BMP"></a>
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        <h1 style="font-family: Montserrat ;font: 25px Verdana, Geneva, sans-serif; margin-left: 400px">Gestão</h1> 
                    </ul>
                </div>
            </nav>-->
        </header>
                    ...
                    <button type="button" class="btn btn-sm pull-right m-r-5"><a style="font-family: Montserrat ;font: 15px Verdana, Geneva, sans-serif" href="index.php">Voltar</a></button><!--<li style="margin-left: 90px"><i class="mdi mdi-menu"></i><span class="hide-menu">Relatorios</span>
					   ...
					   <!--<li style="margin-left: 90px"><i class="mdi mdi-menu"></i><span class="hide-menu">Consultas</span>
                                <ul aria-expanded="false" class="collapse">
                                     <a style="font-family: Montserrat ;font: 15px Verdana, Geneva, sans-serif" href="#"><h4 class="text-muted">Efetivos</h4></a>
									<a style="font-family: Montserrat ;font: 15px Verdana, Geneva, sans-serif" href="#"><h4 class="text-muted">Juntas</h4></a>
							...
							<div class="dropdown">
								...
								<div class="dropdown-menu">
								        <a  href="especialidade.php">Efetivos</a>
										<a  href="#">Juntas</h4></a>
