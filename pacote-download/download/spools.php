		       ...
		       <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <!--<h1 class="text-white"style="font-family: Montserrat ;font: 25px Verdana, Geneva, sans-serif; margin-left: 600px "> Lista Cargos</h1>--> 
				 <div class="navbar-collapse">
                        ...
                        <h1 style="font-family: Montserrat ;font: 25px Verdana, Geneva, sans-serif; margin-left: 400px">Lista de Spools</h1> 
                    </ul>
                </div>
            </nav>
                           ...
                           <table class="table stylish-table"  style="font-family: Montserrat; color:blue;font: 13pt Verdana, Geneva, sans-serif;">
                            <thead >
                                   <tr>
                                       ...
                                       <th scope="col">Tag Documento</th>
                                       <th scope="col">Numero Spools</th>
                              ...
                              while ($row = mysqli_fetch_array($resultado)) {
                                   ?>  
                                    <tr>
                                                 ...
                                                 <td><?php echo utf8_encode($row['tagdocumento']); ?> </td>
                                                 <td><?php echo utf8_encode($row['numerospool']); ?> </td>
                                                 <td><?php echo utf8_encode($row['prioridade']); ?> </td>
