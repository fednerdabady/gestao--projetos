    ...
    <div id="main-wrapper">
        ...
        <header class="topbar" style="height:60px">
		    ...
		    <nav class="navbar top-navbar navbar-expand-md navbar-light">
				...
				<h1 style="font-family: Montserrat ;font: 25px Verdana, Geneva, sans-serif; margin-left: 400px">Funcionarios</h1> 
                    <ul class="navbar-nav mr-auto mt-md-0">
                       <form  class="form-inline mt-2 mt-md-0 pull-right" method="POST" id="form-pesquisa" action="result.php">
                           <input class="form-control mr-sm-2" autocomplete="off" aria-label="Search" type="text" name="buscar" required placeholder="digite o seu CPF">
                        ...
                        <div class="card" style="background-color:lavender;">
                         ...
                         <?php
                            require_once 'conexaoserver2.php';	
                             ...
                             $result = "SELECT  TOP 100 MATRICULA,NOME,RGNUMERO,CPFNUMERO,
							 (SELECT TITULO FROM CS_CARGOS WHERE HANDLE=CARGO)CARGO FROM DO_FUNCIONARIOS ORDER BY HANDLE DESC";
