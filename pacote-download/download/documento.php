    ...
    <div id="main-wrapper">
        ...
        <header class="topbar" style="height:60px">
		      <nav class="navbar top-navbar navbar-expand-md navbar-light">
					...
					<h1 class="text-white"style="font-family: Montserrat ;font: 25px Verdana, Geneva, sans-serif; margin-left: 600px "> Documentação Técnica</h1> 
                </nav>
            <!--<nav class="navbar top-navbar navbar-expand-md navbar-light">
               <a class="navbar-brand" href="#" style="margin-left:-41px;padding-top:0px;padding-bottom:12px"><img class="img-thumbnail" alt="logo" src="./imagens/logopassaura.BMP"></a>
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        <h1 style="font-family: Montserrat ;font: 25px Verdana, Geneva, sans-serif; margin-left: 400px">Documentação Técnica</h1> 
                    </ul>
                </div>
            </nav>-->
        </header>
        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <button type="button" class="btn btn-sm pull-right m-r-5"><a style="font-family: Montserrat ;font: 15px Verdana, Geneva, sans-serif" href="index.php">Voltar</a></button><!--<li style="margin-left: 90px"><i class="mdi mdi-menu"></i><span class="hide-menu">Relatorios</span>
                         <!--<li style="margin-left: 100px"><i class="mdi mdi-menu"></i><span class="hide-menu">Documento</span>
                ...
                <!--<button type="button" class="btn btn-sm"><a style="font-family: Montserrat ;font: 15px Verdana, Geneva, sans-serif" href="#">Documento </a></button>
                <button type="button" class="btn btn-sm"><a style="font-family: Montserrat ;font: 15px Verdana, Geneva, sans-serif" href="#">Guia de Remesa</a></button>-->
                 ...
                 <!--<div class=" col-md-1 col-lg-4 pull-right">
                            ...
                            <div class="card">
                                        <div class="card-body" >
                                                ...
                                                <a style="font-family: Montserrat ;font: 15px Verdana, Geneva, sans-serif" href="#"><h4 class="text-muted">Consulta doc.recebidos</h4></a>
                                                <a style="font-family: Montserrat ;font: 15px Verdana, Geneva, sans-serif" href="#"><h4 class="text-muted">Consulta doc.distribuidos</h4></a>
                                                <a style="font-family: Montserrat ;font: 15px Verdana, Geneva, sans-serif" href="#"><h4 class="text-muted">Lista de doc. recebidos</h4></a>
                                                <a style="font-family: Montserrat ;font: 15px Verdana, Geneva, sans-serif" href="#"><h4 class="text-muted">Lista de doc. distribuidos</h4></a>
                                                <a style="font-family: Montserrat ;font: 15px Verdana, Geneva, sans-serif" href="#"><h4 class="text-muted">Lista de doc. p/detentor</h4></a>
                                                <a style="font-family: Montserrat ;font: 15px Verdana, Geneva, sans-serif" href="#"><h4 class="text-muted">Finalidade</h4></a>
