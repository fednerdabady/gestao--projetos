    ...
    <div id="main-wrapper">
		       ...
		       <nav class="navbar top-navbar navbar-expand-md navbar-light">
				...
				<div class="navbar-collapse">
                    <ul class="navbar-nav my-lg-0">
                        <h1 style="font-family: Montserrat ;font: 25px Verdana, Geneva, sans-serif; margin-left: 400px">Lista Cargos</h1> 
						<form  class="form-inline mt-2 mt-md-0 pull-right" method="POST" id="form-pesquisa" action="pesqCargo.php">
                           <input class="form-control mr-sm-2" autocomplete="off" aria-label="Search" type="text" name="buscar" required placeholder="digite o CBO">
        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <!-- End Sidebar navigation  class="table stylish-table"-->
            </div>
            <!-- End Sidebar scroll-->
        </aside>
                        ...
                        <div class="card" style="background-color:lavender;">
                         ...
                         <?php
                            require_once 'conexaoserver2.php';			
                                    ...
                                    $result = "SELECT TOP 100 TITULO,CBO,DESCRICAO FROM CS_CARGOS ";
