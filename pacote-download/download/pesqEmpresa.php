				...
				<h1 style="font-family: Montserrat ;font: 25px Verdana, Geneva, sans-serif; margin-left: 400px">Pesquisar</h1> 
                    <ul class="navbar-nav mr-auto mt-md-0">
                       <form  class="form-inline mt-2 mt-md-0 pull-right" method="POST" id="form-pesquisa" action="result.php">
                            <input class="form-control mr-sm-2" autocomplete="off" placeholder="Digite o CGCCPF" aria-label="Search" type="text" name="buscar" required>
        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    ...
                    <button type="button" class="btn btn-sm pull-right"><a  style="font-family: Montserrat ;font: 15px Verdana, Geneva, sans-serif" href="listaempresa.php">Voltar</a></button>
                        ...
                        <div class="card" style="background-color:lavender;">
                         ...
                         <?php
                            require_once 'conexaoServer.php';			
                                    $buscar = $_POST['buscar'];  
                                    $result = "SELECT TOP 1 NOME,CGCCPF,INSCRICAOESTADUAL FROM GN_PESSOAS WHERE CGCCPF   LIKE '%".$buscar."%' AND TIPO=2";
