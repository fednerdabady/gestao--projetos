               ...
               <a class="navbar-brand" href="#" style="margin-left:-41px;padding-top:0px;padding-bottom:12px"><img class="img-thumbnail" alt="logo" src="./imagens/logopassaura.BMP"></a>
				...
				<h1 style="font-family: Montserrat ;font: 25px Verdana, Geneva, sans-serif; margin-left: 400px">Pesquisar</h1> 
                    <ul class="navbar-nav mr-auto mt-md-0">
                       <form  class="form-inline mt-2 mt-md-0 pull-right" method="POST" id="form-pesquisa" action="pesqCargo.php">
                            <input class="form-control mr-sm-2" autocomplete="off" placeholder="Digite o CBO" aria-label="Search" type="text" name="buscar" required>
        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    ...
                    <button type="button" class="btn btn-sm pull-right"><a  style="font-family: Montserrat ;font: 15px Verdana, Geneva, sans-serif" href="listatabelacargo.php">Voltar</a></button>
                    ...
                    <div class="col-lg-12">
                        <div class="card" style="background-color:lavender;">
                           ...
                           <table class="table table-hover"  style="font-family: Montserrat; color:blue;font: 13pt Verdana, Geneva, sans-serif;">
                             <thead style="font-family: Montserrat; color:blue;font: 13pt Verdana, Geneva, sans-serif;">
                                   <tr >
                                       
                                       
                                       <th style="font-family: Montserrat; color:#002752;font: 13pt Verdana, Geneva, sans-serif;">TITULO</th>
                                        <th style="font-family: Montserrat; color:#002752;font: 13pt Verdana, Geneva, sans-serif;">CBO</th>
                                       <th style="font-family: Montserrat; color:#002752;font: 13pt Verdana, Geneva, sans-serif;">DESCRICAO</th>
                                   </tr>
                            </thead>
                            <tbody>
                         ...
                         <?php
                            require_once 'conexaoserver2.php';			
                                    ...
                                    $result = "SELECT TOP 1 TITULO,CBO,DESCRICAO FROM CS_CARGOS WHERE CBO  LIKE '%".$buscar."%' ";
                              ...
                              while ($row = sqlsrv_fetch_array($resultado,SQLSRV_FETCH_ASSOC)) {
								   ?>  
                                    <tr>
                                                 ...
                                                 <td><?php echo utf8_encode($row['CBO']); ?> </td>
