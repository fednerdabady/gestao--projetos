                ...
                <!--<h1 class="text-white"style="font-family: Montserrat ;font: 25px Verdana, Geneva, sans-serif; margin-left: 600px "> Lista Cargos</h1>--> 
				 <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        <h1 style="font-family: Montserrat ;font: 25px Verdana, Geneva, sans-serif; margin-left: 400px">Lista de Materias</h1> 
                    </ul>
                </div>
            </nav>
                        ...
                        <div class="card">
                           ...
                           <table class="table stylish-table"  style="font-family: Montserrat; color:blue;font: 13pt Verdana, Geneva, sans-serif;">
                            <thead >
                                   <tr>
                                       ...
                                       <th scope="col">Codigo Estoque</th>
                                       <th scope="col">Codigo Localizacao</th>
                                       <th scope="col">Titulo Localizacao</th>
                                       <th scope="col">Forma Armazenagem</th>
                         ...
                         <?php
                            require_once 'conexao.php';			
                                    ...
                                    $result = "SELECT * from estoquelocalizacao";
                              ...
                              while ($row = mysqli_fetch_array($resultado)) {
								   ?>  
                                    <tr>
                                                 ...
                                                 <td><?php echo utf8_encode($row['LocalEstoqueCodigo']); ?> </td>
                                                 <td><?php echo utf8_encode($row['codigoLocalizacao']); ?> </td>
                                                 <td><?php echo utf8_encode($row['TituloLocalizacao']); ?> </td>
                                                 <td><?php echo utf8_encode($row['FormaArmazenagem']); ?> </td>
