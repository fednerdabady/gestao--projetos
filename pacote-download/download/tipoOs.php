		      ...
		      <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <!--<h1 class="text-white"style="font-family: Montserrat ;font: 25px Verdana, Geneva, sans-serif; margin-left: 600px "> Lista Cargos</h1>--> 
				 <div class="navbar-collapse">
                        ...
                        <h1 style="font-family: Montserrat ;font: 25px Verdana, Geneva, sans-serif; margin-left: 400px">Tipo de Ordem de Servico</h1> 
                    </ul>
                </div>
            </nav>
            <!--<nav class="navbar top-navbar navbar-expand-md navbar-light">
        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    ...
                    <button type="button" class="btn btn-sm pull-right"><a  style="font-family: Montserrat ;font: 15px Verdana, Geneva, sans-serif" href="pagina_planejamento.php">Voltar</a></button>
                        ...
                        <div class="card">
                           ...
                           <table class="table stylish-table"  style="font-family: Montserrat; color:blue;font: 13pt Verdana, Geneva, sans-serif;">
                            <thead >
                                   <tr>
                                       ...
                                       <th scope="col">Sigla Ordem Servico</th>
                                       <th scope="col">Descrição Ordem Servico</th>
                                        <th scope="col">Tipo Servico</th>
                                         <th scope="col">Peso Servico</th>
                         ...
                         <?php
                            require_once 'conexao.php';         
                                    ...
                                    $result = "SELECT * FROM tipoordemservico";
                              ...
                              while ($row = mysqli_fetch_array($resultado)) {
                                   ?>  
                                    <tr>
                                                 ...
                                                 <td><?php echo utf8_encode($row['siglaOrdemServico']); ?> </td>
                                                 <td><?php echo utf8_encode($row['descOrdemServico']); ?> </td>
                                                 <td><?php echo utf8_encode($row['tipoServico']); ?> </td>
                                                 <td><?php echo utf8_encode($row['pesoServico']); ?> </td>
