    ...
    <div id="main-wrapper">
        ...
        <header class="topbar" style="height:60px">
		      <nav class="navbar top-navbar navbar-expand-md navbar-light">
					...
					<h1 class="text-white"style="font-family: Montserrat ;font: 25px Verdana, Geneva, sans-serif; margin-left: 600px "> Qualidade</h1> 
                </nav>
            <!--<nav class="navbar top-navbar navbar-expand-md navbar-light">
               <a class="navbar-brand" href="#" style="margin-left:-41px;padding-top:0px;padding-bottom:12px"><img class="img-thumbnail" alt="logo" src="./imagens/logopassaura.BMP"></a> 
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        <h1 style="font-family: Montserrat ;font: 25px Verdana, Geneva, sans-serif; margin-left: 400px"> Qualidade</h1> 
                    </ul>
                </div>
            </nav>-->
        </header>
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                   <ul id="sidebarnav">
						<button type="button" class="btn btn-sm"><a style="font-family: Montserrat ;font: 15px Verdana, Geneva, sans-serif" href="documento.php">Documentaçao Técnico</a></button>
						<button type="button" class="btn btn-sm"><a style="font-family: Montserrat ;font: 15px Verdana, Geneva, sans-serif" href="inspecoes.php">Inspeção</a></button>
					...
					<!--<a style="font-family: Montserrat ;font: 15px Verdana, Geneva, sans-serif; margin-left: 700px" href="index.php" aria-expanded="false"><i class="mdi mdi-gauge"></i><span class="hide-menu">Página Principal </span></a>-->
							   ...
							   <ul aria-expanded="false" class="collapse">
								   <li><a  href="especialidade.php">Especialidades</a></li>
									<li><a  href="#">Finalidades</a></li>
									<li><a  href="#">Documentos Técnicos</a></li>
									<li><a  href="#">Guias Remessa Documentos</a></li>
									<li><a  href="#">Tags</a></li>
							...
							<div class="dropdown">
								...
								<div class="dropdown-menu">
										...
										<a  href="#">Finalidades</a>
										<a  href="#">Documentos Técnicos</a>
										<a  href="#">Guias Remessa Documentos</a>
										<a  href="#">Tags</a>
