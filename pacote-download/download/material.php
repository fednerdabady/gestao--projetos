		...
		<header class="topbar"style="height:60px">
                ...
                <!--<h1 class="text-white"style="font-family: Montserrat ;font: 25px Verdana, Geneva, sans-serif; margin-left: 600px "> Lista Cargos</h1>--> 
				 <div class="navbar-collapse">
                        ...
                        <h1 style="font-family: Montserrat ;font: 25px Verdana, Geneva, sans-serif; margin-left: 400px">Lista de Material</h1> 
                    </ul>
                </div>
            </nav>
            <!--<nav class="navbar top-navbar navbar-expand-md navbar-light">
        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    ...
                    <!--<button type="button" class="btn btn-sm"><a style="font-family: Montserrat ;font: 15px Verdana, Geneva, sans-serif" href="novomaterial.php">Novo</a></button>-->
                    <button type="button" class="btn btn-sm pull-right"><a  style="font-family: Montserrat ;font: 15px Verdana, Geneva, sans-serif" href="pagina_material.php">Voltar</a></button>
                        ...
                        <div class="card" style="background-color:lavender;">
                           ...
                           <table class="table table-hover"  style="font-family: Montserrat;color:blue;font: 13pt Verdana, Geneva, sans-serif;">
                            <thead >
                                   <tr>
                                       ...
                                       <th style="font-family: Montserrat; color:#002752;font: 13pt Verdana, Geneva, sans-serif;">CODIGO</th>
                                       <th style="font-family: Montserrat; color:#002752;font: 13pt Verdana, Geneva, sans-serif;">CodMaterial</th>
                                       <th style="font-family: Montserrat; color:#002752;font: 13pt Verdana, Geneva, sans-serif;">DiscriminacaoMaterial</th>
                                       <th style="font-family: Montserrat; color:#002752;font: 13pt Verdana, Geneva, sans-serif;">Sigla</th>
                                       <th style="font-family: Montserrat; color:#002752;font: 13pt Verdana, Geneva, sans-serif;">DimensoesMaterial</th>
                                       <th style="font-family: Montserrat; color:#002752;font: 13pt Verdana, Geneva, sans-serif;">PesoMAterial</th>
									   <th style="font-family: Montserrat; color:#002752;font: 13pt Verdana, Geneva, sans-serif;">EspecificacaoMaterial</th>
                         ...
                         <?php
                            require_once 'conexao.php';			
                                     ...
                                     $result = "SELECT B.sigla,c.SiglaMaterial,A.*"
                                            . "FROM material A ,unidade B, especicacaomaterial c "
                                            . "WHERE B.codigo=a.unidadeMaterial and c.codigo=a.especificacaoCod";
                              ...
                              while ($row = mysqli_fetch_array($resultado)) {
								   ?>  
                                    <tr>
                                                 ...
                                                 <td><?php echo utf8_encode($row['codMaterial']); ?> </td>
                                                 <td><?php echo utf8_encode($row['discriminacaoMaterial']); ?> </td>
                                                 <td><?php echo utf8_encode($row['sigla']); ?> </td>
                                                 <td><?php echo utf8_encode($row['dimensoesMaterial']); ?> </td>
                                                 <td><?php echo utf8_encode($row['pesoMaterial']); ?> </td>
												  <td><?php echo utf8_encode($row['SiglaMaterial']); ?> </td>
