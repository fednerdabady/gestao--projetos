		    ...
		    <nav class="navbar top-navbar navbar-expand-md navbar-light">
				...
				<div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        <h1 style="font-family: Montserrat ;font: 25px Verdana, Geneva, sans-serif; margin-left: 400px">Lista Empresa</h1> 
						<form  class="form-inline mt-2 mt-md-0 pull-right" method="POST" id="form-pesquisa" action="pesqEmpresa.php">
                           <input class="form-control mr-sm-2" autocomplete="off" aria-label="Search" type="text" name="buscar" required placeholder="digite o CGCCPF">
                        ...
                        <div class="card">
                           ...
                           <table class="table stylish-table"  style="font-family: Montserrat; color:blue;font: 13pt Verdana, Geneva, sans-serif;">
                            <thead >
                                   <tr>
                                       ...
                                       <th style="font-family: Montserrat; color:#002752;font: 13pt Verdana, Geneva, sans-serif;">CGCCPF</th>
                                       <th style="font-family: Montserrat; color:#002752;font: 13pt Verdana, Geneva, sans-serif;">INSCRICAOESTADUAL</th>
                                   </tr>
                            </thead>
                            <tbody>
                         ...
                         <?php
                            require_once 'conexaoServer.php';			
                                    ...
                                    $result = "SELECT  TOP 100 NOME,CGCCPF,INSCRICAOESTADUAL FROM GN_PESSOAS WHERE TIPO=2 ORDER BY NOME";
                              ...
                              while ($row = sqlsrv_fetch_array($resultado,SQLSRV_FETCH_ASSOC)) {
								   ?>  
                                    <tr>
                                        ...
                                        <td><?php echo utf8_encode($row['CGCCPF']); ?> </td>
                                        <td><?php echo utf8_encode($row['INSCRICAOESTADUAL']); ?> </td>
                                       <!-- <td>
