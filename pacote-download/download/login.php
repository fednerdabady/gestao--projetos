...
<head>
    ...
    <body>
       ...
       <header class="topbar" style="height:60px">
	           ...
	           <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <h1 class="text-white"style="font-family: Montserrat ;font: 25px Verdana, Geneva, sans-serif;margin-left: 300px "> Gestão de Projetos</h1> 
            </nav>
            <!--<nav class="navbar top-navbar navbar-expand-md navbar-light">
    ...
    <section id="wrapper">
        ...
        <div class="login-register" style="background-color:lavender;">
            ...
            <div class="card-body">
                <form class="form-horizontal form-material" id="loginform"  method="post" action="auth.php">
